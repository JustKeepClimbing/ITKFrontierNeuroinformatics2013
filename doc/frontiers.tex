...
developed over the past fourteen years of the project is presented.
\section{}

\tiny
 \keyFont{ \section{Keywords:} Reproducibility, ITK, Insight Toolkit, Insight Journal, Code Review, Open Science} %All article types: you may provide up to 8 keywords; at least 5 are mandatory.
\end{abstract}
...
opinion-based evaluations that deviate from empirical evidence.
This drift has denigrated what used to be scientific work, back to the
practice of the ``natural philosophy'', in which we simply imagine models of the
natural world and evaluate them based on aesthetic appeals and desire for
self-consistency.
...
ITK has made it possible to restore the true practice of the scientific method
in the field of medical image analysis. By providing a common platform in which
image analysis algorithms and processing techniques can be implemented and
freely disseminated, ITK empowers all to verify the experimental work of
image analysis research activities. This requires that researchers adhere to
the true practice of the scientific method and publish the full details of
their methodology, including the source code, data, parameters and auxiliary
documents that are required for a third party to independently repeat the work
...
To ensure the code quality of the toolkit and growth of the ITK community,
...
The ITK community embraced the use of Git as part of the modernization activities
...
page numbers as references during discussion, and a process to distribute an
article to reviewers and communicate author replies.  Documentation is a mechanism
through which reviewers can evaluate reproducibility. However,  the technical
nature of code solicits greater technical capabilities of the tools and methods
used to evaluate its reproducibility.
...
refactoring effort that culminated into ITKv4.  As a result of the modularization, the
initial monolithic code base of about 12,000 files was partitioned into more
than 100 modules.  And, as of October 2013, ITK main code repository contains
...
submitting to Insight Journal first. An Insight Journal article that describes the
background, functionalities, and design behind the module is a great way
to provide extra documentation.


\subsection{Open Publication: The Insight Journal}
ITK was conceived as an encyclopedia of image analysis algorithms
...
is vital to have a quality control mechanism in place. This
eliminates defects in the code before they are introduced into the repository, and
...
is invited to review and test the code contributions and a conversation
ensues, where the submitters and reviewers discuss any limitations or
imperfections in the suggested changes. During these exchanges, test builds are
...
%  the following statistics were obtained with the script
%
%            src/insight-journal-statistics.sh
%
% and data/IJ-Stats-2013.xlsx
%
...
by community members. There are not a few individual nodes from which radiate all
knowledge and advancement, but, rather, a bi-directional network where knowledge and
...
isolated knowledge, but instead fully connected, with few hops from any given
