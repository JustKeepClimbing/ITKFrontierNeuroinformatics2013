...
image analysis algorithms and processing techniques can be implemented and can
be freely disseminated, ITK empowers all to verify the experimental work of
